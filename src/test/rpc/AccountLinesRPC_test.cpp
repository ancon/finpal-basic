...
public:
    void testAccountLines()
    {
        ...
        for (char c = 0; c <= ('Z' - 'A'); ++c)
        {
            ...
            env(trust(alice, gw2Currency(0), gw2, tfSetNoMtchain | tfSetFreeze));
        }
        env.close();
        ...
        }
        {
            ...
            BEAST_EXPECT(line[jss::no_FinPal].asBool() == true);
        ...
        }
        {
            ...
            BEAST_EXPECT(lineA[jss::no_FinPal_peer].asBool() == true);
    ...
    void testAccountLineDelete()
    {
        ...
        //   o alice offers to buy 100 USD for 100 M.
        //   o becky offers to sell 100 USD for 100 M.
        ...
        Account const gw1 {"gw1"};
        Account const gw2 {"gw2"};
        env.fund(M(10000), alice, becky, cheri, gw1, gw2);
        env.close();
        ...
        // alice offers to buy 100 USD for 100 M.
        env(offer(alice, USD(100), M(100)));
        env.close();

        // becky offers to buy 100 M for 100 USD.
        env(offer(becky, M(100), USD(100)));
        env.close();
    ...
    void testAccountLines2()
    {
        ...
        Env env(*this);
        {
            ...
            BEAST_EXPECT(lines.isMember(jss::FinPalrpc) && lines[jss::FinPalrpc] == "2.0");
        }
        {
            // account_lines with no account.
            auto const lines = env.rpc ("json2", "{ "
        ...
        [this, &env](Account const& account, LedgerInfo const& info, int count)
        {
            ...
            BEAST_EXPECT(linesSeq.isMember(jss::FinPalrpc) && linesSeq[jss::FinPalrpc] == "2.0");
            ...
            BEAST_EXPECT(linesHash.isMember(jss::FinPalrpc) && linesHash[jss::FinPalrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(linesA.isMember(jss::FinPalrpc) && linesA[jss::FinPalrpc] == "2.0");
            ...
            BEAST_EXPECT(linesB.isMember(jss::FinPalrpc) && linesB[jss::FinPalrpc] == "2.0");
            ...
            BEAST_EXPECT(linesC.isMember(jss::FinPalrpc) && linesC[jss::FinPalrpc] == "2.0");
            ...
            BEAST_EXPECT(linesD.isMember(jss::FinPalrpc) && linesD[jss::FinPalrpc] == "2.0");
    ...
    void testAccountLineDelete2()
    {
        ...
        BEAST_EXPECT(linesBeg.isMember(jss::FinPalrpc) && linesBeg[jss::FinPalrpc] == "2.0");
        ...
        BEAST_EXPECT(linesEnd.isMember(jss::FinPalrpc) && linesEnd[jss::FinPalrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountLinesRPC,app,mtchain);
