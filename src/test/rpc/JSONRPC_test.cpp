...
{ "Even though 'Amount' may not be M for pathfinding, 'SendMax' may be M.",
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
public:
    ...
    void testTransactionRPC ()
    {
        ...
        env.fund(test::jtx::M(100000), a, ed, g);
        env.close();
...
BEAST_DEFINE_TESTSUITE(JSONRPC,mtchain_app,mtchain);
