...
public:
    ...
    void testNonAdminMinLimit()
    {
        ...
        {
            Json::Value jvo = offer(bob, M(100 + i), USD_gw(1));
    ...
    void testSequential(bool as_admin)
    {
        ...
        env(offer(bob, M(100), USD_bob(1)));
        env(offer(bob, M(100), USD_gw(1)));
        env(offer(bob, M(10),  USD_gw(2)));
...
BEAST_DEFINE_TESTSUITE(AccountOffers,app,mtchain);
