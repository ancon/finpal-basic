...
public:
    ...
    testSetAndClear()
    {
        ...
        for (auto SetOrClear : {true,false})
        {
            ...
            BEAST_EXPECT(gline0[jss::no_FinPal].asBool() == SetOrClear);
            ...
            BEAST_EXPECT(aline0[jss::no_FinPal_peer].asBool() == SetOrClear);
        }
    }
    ...
    testNegativeBalance()
    {
        ...
        BEAST_EXPECT(!lines[0u].isMember(jss::no_FinPal));
    }
    ...
    testDefaultMTChain()
    {
...

        {
            ...
            BEAST_EXPECT(line0[jss::no_FinPal_peer].asBool() == true);
        }
        {
            Json::Value params;
            ...
            auto lines = env.rpc("json", "account_lines", to_string(params));
            auto const& line0 = lines[jss::result][jss::lines][0u];
            BEAST_EXPECT(line0[jss::no_FinPal].asBool() == true);
        }
        {
            Json::Value params;
            params[jss::account] = gw.human();
            ...
            auto lines = env.rpc("json", "account_lines", to_string(params));
            auto const& line0 = lines[jss::result][jss::lines][0u];
            BEAST_EXPECT(line0[jss::no_FinPal].asBool() == false);
        }
        {
            Json::Value params;
            ...
            auto lines = env.rpc("json", "account_lines", to_string(params));
            auto const& line0 = lines[jss::result][jss::lines][0u];
            BEAST_EXPECT(line0[jss::no_FinPal_peer].asBool() == false);
        }
    }
