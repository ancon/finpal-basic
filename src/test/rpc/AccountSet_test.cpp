...
public:
    ...
    void testNullAccountSet()
    {
        ...
        env.fund(M(10000), nomtchain(alice));
    ...
    void testBadInputs()
    {
        ...
        auto jt = fset(alice, asfDisallowM);
        jt[jss::ClearFlag] = asfDisallowM;
        ...
        jt = fset(alice, asfDisallowM);
        jt[sfFlags.fieldName] = tfAllowM;
        env(jt, ter(temINVALID_FLAG));
...
BEAST_DEFINE_TESTSUITE(AccountSet,app,mtchain);
