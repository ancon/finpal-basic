...
#ifndef MTCHAIN_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define MTCHAIN_ASSETS_ENABLE_STD_HASH 0
# else
#  define MTCHAIN_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
#if MTCHAIN_ASSETS_ENABLE_STD_HASH
...
BEAST_DEFINE_TESTSUITE(Issue,protocol,mtchain);
