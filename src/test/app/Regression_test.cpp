...
struct Regression_test : public beast::unit_test::suite
{
    ...
    void testOffer1()
    {
        ...
        env(offer("alice", USD(10), M(10)), require(owners("alice", 1)));
        env(offer("alice", USD(20), M(10)), json(R"raw(
                { "OfferSequence" : 2 }
    ...
    {
        testcase("Account balance < fee destroys correct amount of M");
        using namespace jtx;
        Env env(*this);
        env.memoize("alice");
        ...
        auto const aliceM = 400;
        auto const aliceAmount = M(aliceM);
            ...
            env.app().timeKeeper().closeTime());
        {
            ...
            auto const result = mtchain::apply(env.app(),
        ...
        }
        {
            ...
            BEAST_EXPECT(balance == M(0));
        }
        expectedDrops -= aliceM * dropsPerM<int>::value;
        BEAST_EXPECT(next->info().drops == expectedDrops);
    }
...
BEAST_DEFINE_TESTSUITE(Regression,app,mtchain);
