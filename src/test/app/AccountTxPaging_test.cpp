...
class AccountTxPaging_test : public beast::unit_test::suite
{
    ...
    testAccountTxPaging ()
    {
        ...
        for (auto i = 0; i < 5; ++i)
        {
            ...
            env(offer(A1, M(11), A1["USD"](1)));
            env(offer(A2, M(10), A2["USD"](1)));
            env(offer(A3, M(9),  A3["USD"](1)));
            env.close();
        }
...
BEAST_DEFINE_TESTSUITE(AccountTxPaging,app,mtchain);
