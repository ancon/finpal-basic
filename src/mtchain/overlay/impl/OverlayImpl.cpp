...
#include <mtchain/overlay/impl/ConnectAttempt.h>
#include <mtchain/overlay/impl/OverlayImpl.h>
#include <mtchain/overlay/impl/PeerImp.h>
#include <mtchain/overlay/impl/TMHello.h>
#include <mtchain/peerfinder/make_Manager.h>
#include <mtchain/protocol/STExchange.h>
...
OverlayImpl::onPrepare()
{
    ...
    if (bootstrapIps.empty ())
        bootstrapIps.push_back ("r.mtchain.io 51235");
    ...
    // Add the ips_fixed from the MTChain-core.cfg file
...
/** The number of active peers on the network
    ...
    and are running the MTChain protocol.
*/
std::size_t
OverlayImpl::size()
{
