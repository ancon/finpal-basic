...
#ifndef MTCHAIN_OVERLAY_PEERIMP_H_INCLUDED
#define MTCHAIN_OVERLAY_PEERIMP_H_INCLUDED

#include <mtchain/app/ledger/LedgerProposal.h>
#include <mtchain/basics/Log.h> // deprecated
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the MTChain protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of FinPald that the peer is running, if reported. */
    std::string
    getVersion() const;
