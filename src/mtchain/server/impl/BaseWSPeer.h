...
#ifndef MTCHAIN_SERVER_BASEWSPEER_H_INCLUDED
#define MTCHAIN_SERVER_BASEWSPEER_H_INCLUDED

#include <mtchain/server/impl/BasePeer.h>
...
start_timer()
{
    ...
    static constexpr std::chrono::seconds timeoutLocal{30}; //extend local time out from 3 to 30
    error_code ec;
