...
additional M for transactions, requiring a proof of work to be
...
overlay network implementing the MTChain protocol.
...
In FinPald, the Application holds a unique instance of Resource::Manager,
