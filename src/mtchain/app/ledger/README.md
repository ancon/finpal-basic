...
There are two ledgers that are the most important for a FinPald server to have:
...
A distributed agreement protocol. MTChain uses the consensus process to solve
...
the transaction increments the sequence number.  This is how mtchain prevents
...
**index:** 256-bit hash of this MTChainState.
...
The MTChain server permits clients to subscribe to a continuous stream of
