...
#ifndef MTCHAIN_APP_LEDGER_LEDGER_H_INCLUDED
#define MTCHAIN_APP_LEDGER_LEDGER_H_INCLUDED
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an M balance equal to the total amount
        of M in the system. No more M than the amount which
    ...
    */
    ...
    void
    rawDestroyM (MAmount const& fee) override
    {
		//After fee_pool been actived, DO NOT destory M in Ledger
        //info_.drops -= fee;
		info_.feePool += fee;
    }
    ...
    */
	...
	void setFeePool(std::uint64_t feePool)
	{
		info_.feePool = feePool;
	}
