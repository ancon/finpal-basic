...
#ifndef MTCHAIN_APP_LEDGER_LEDGERMASTER_H_INCLUDED
#define MTCHAIN_APP_LEDGER_LEDGERMASTER_H_INCLUDED
...
#include <mtchain/app/ledger/LedgerCleaner.h>
#include <mtchain/app/ledger/LedgerHistory.h>
#include <mtchain/app/ledger/LedgerHolder.h>
#include <mtchain/app/misc/CanonicalTXSet.h>
#include <mtchain/basics/chrono.h>
#include <mtchain/basics/RangeSet.h>
#include <mtchain/basics/ScopedLock.h>
...
public:
    ...
    */
    ...
    {
        if (timer == tryAdvanceTimer_)
        {
            tryAdvance();
            tryAdvanceTimer_.setExpiration(60s);
            return;
        }
    }
...
private:
    ...
    std::uint32_t last_missing_ledger_;
    DeadlineTimer tryAdvanceTimer_;
};
