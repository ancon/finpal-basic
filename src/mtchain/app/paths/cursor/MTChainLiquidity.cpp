...
{
    JLOG (mtchainCalc.j_.trace())
        << systemName() + "Liquidity>"
        << " qualityIn=" << qualityIn
    ...
    if (qualityIn >= qualityOut)
    {
        ...
        JLOG (mtchainCalc.j_.trace()) << systemName() + "Liquidity: No fees";
    ...
    else
    {
        ...
        JLOG (mtchainCalc.j_.trace()) << systemName() + "Liquidity: Fee";
        ...
        if (!uRateMax || uRate <= uRateMax)
        {
            ...
            else
            {
                ...
                JLOG (mtchainCalc.j_.trace())
                    << systemName() + "Liquidity:4: saCurReq=" << saCurReq;
...
quality_in (
    ...
    Currency const& currency)
{
    return mtchainQuality (view, uToAccountID, uFromAccountID, currency,
