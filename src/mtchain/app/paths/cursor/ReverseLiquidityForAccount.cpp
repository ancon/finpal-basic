...
//
// Currency cannot be M because we are rippling.
//
...
TER PathCursor::reverseLiquidityForAccount () const
{
    ...
    // page section: https://mtchain.io/wiki/Transit_Fees#Implementation
    ...
    else if (!previousNodeIsAccount && nextNodeIsAccount)
    {
        ...
        else
        {
            ...
            // deliver -> redeem
            // TODO(tom): now we have more checking in nodeMTChain, these checks
            // might be redundant.
