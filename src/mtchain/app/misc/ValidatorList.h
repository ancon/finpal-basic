...
#ifndef MTCHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
#define MTCHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
...
/**
    ...
    MTChaind accepts ledger proposals and validations from trusted validator
    ...
    This class manages the set of validation public keys the local FinPald node
