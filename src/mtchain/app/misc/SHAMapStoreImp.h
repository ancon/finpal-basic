...
#ifndef MTCHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define MTCHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
#include <mtchain/nodestore/impl/Tuning.h>
...
private:
    ...
    std::string const dbPrefix_ = systemName() + "db";
...
private:
    ...
    // If FinPald is not healthy, defer rotate-delete.
