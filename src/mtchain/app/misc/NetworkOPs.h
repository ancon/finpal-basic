...
#ifndef MTCHAIN_APP_MISC_NETWORKOPS_H_INCLUDED
#define MTCHAIN_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    FinPald / NetworkOPs. However, client software connecting to non-local
    instances of FinPald will need to be hardened to protect against hostile
