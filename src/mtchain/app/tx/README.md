...
In order to enhance the flexibility of MTChain and provide support for enhanced
...
Some technical details, including tables indicating some of the MTChain
commands and ledger entries to be used for implementing multi-signature, are
currently listed on the [wiki](https://mtchain.io/wiki/Multisign) but will
...
transaction is to be signed outside the MTChain network and only submitted
...
some messaging mechanism outside the MTChain network to disseminate the proposed
...
out and discussed on the [wiki](https://mtchain.io/wiki/Multisign). This
...
Currently transactions on the MTChain network require the use of sequence
