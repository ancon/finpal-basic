...
#ifndef MTCHAIN_CORE_CONFIGSECTIONS_H_INCLUDED
#define MTCHAIN_CORE_CONFIGSECTIONS_H_INCLUDED
...
#define SECTION_IPFS                    "IPFS"
#define SECTION_FILE_UPLOAD_DIR         "file_upload_dir"
#define SECTION_MINERS                  "miners"
