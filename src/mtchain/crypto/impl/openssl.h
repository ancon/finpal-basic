...
#ifndef MTCHAIN_OPENSSL_H
#define MTCHAIN_OPENSSL_H
...
int sm2_compute_message_digest(uint8_t const* msg, size_t msglen,
                               uint8_t const* pubic_key, size_t public_len,
                               uint8_t *out, size_t *poutlen = nullptr,
                               const char *id = nullptr, size_t idlen = 0,
