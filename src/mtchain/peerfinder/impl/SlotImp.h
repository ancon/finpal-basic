...
#ifndef MTCHAIN_PEERFINDER_SLOTIMP_H_INCLUDED
#define MTCHAIN_PEERFINDER_SLOTIMP_H_INCLUDED

#include <mtchain/peerfinder/Slot.h>
#include <mtchain/peerfinder/PeerfinderManager.h>
#include <mtchain/beast/core/CompilerConfig.h>
