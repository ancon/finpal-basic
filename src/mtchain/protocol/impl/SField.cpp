...
SF_U32 const sfStoreFee            = make::one<SF_U32::type>(&sfStoreFee,            STI_UINT32, 40, "StoreFee");
SF_U32 const sfDownloadFee         = make::one<SF_U32::type>(&sfDownloadFee,         STI_UINT32, 41, "DownloadFee");
...
SF_U64 const sfTokenIndex    = make::one<SF_U64::type>(&sfTokenIndex,    STI_UINT64, 9, "TokenIndex");
SF_U64 const sfOwnerTokenIndex = make::one<SF_U64::type>(&sfOwnerTokenIndex, STI_UINT64, 10, "OwnerTokenIndex");
SF_U64 const sfTokenNumber   = make::one<SF_U64::type>(&sfTokenNumber,   STI_UINT64, 11,"TokenNumber");
SF_U64 const sfAssetNumber   = make::one<SF_U64::type>(&sfAssetNumber,   STI_UINT64, 12,"AssetNumber");
SF_U64 const sfAssetIndex    = make::one<SF_U64::type>(&sfAssetIndex,    STI_UINT64, 13,"AssetIndex");
...
SF_U256 const sfAssetID         = make::one<SF_U256::type>(&sfAssetID,         STI_HASH256, 10,"AssetID");
SF_U256 const sfTokenID         = make::one<SF_U256::type>(&sfTokenID,         STI_HASH256, 11,"TokenID");
...
SF_Amount const sfTransferFee = make::one<SF_Amount::type>(&sfTransferFee, STI_AMOUNT, 11, "TransferFee");
SF_Amount const sfLowOut      = make::one<SF_Amount::type>(&sfLowOut,      STI_AMOUNT, 12, "LowOut");
SF_Amount const sfHighOut     = make::one<SF_Amount::type>(&sfHighOut,     STI_AMOUNT, 13, "HighOut");
SF_Amount const sfLowIn       = make::one<SF_Amount::type>(&sfLowIn,       STI_AMOUNT, 14, "LowIn");
SF_Amount const sfHighIn      = make::one<SF_Amount::type>(&sfHighIn,      STI_AMOUNT, 15, "HighIn");

// currency amount (uncommon)
SF_Amount const sfMinimumOffer    = make::one<SF_Amount::type>(&sfMinimumOffer,    STI_AMOUNT, 16, "MinimumOffer");
SF_Amount const sfMTChainEscrow   = make::one<SF_Amount::type>(&sfMTChainEscrow,   STI_AMOUNT, 17, "MTChainEscrow");
SF_Amount const sfDeliveredAmount = make::one<SF_Amount::type>(&sfDeliveredAmount, STI_AMOUNT, 18, "DeliveredAmount");
SF_Amount const sfTxnFee          = make::one<SF_Amount::type>(&sfTxnFee,          STI_AMOUNT, 19, "TxnFee",SField::sMD_Default, SField::notSigning);
SF_Amount const sfTakerPaysTotal  = make::one<SF_Amount::type>(&sfTakerPaysTotal,  STI_AMOUNT, 20, "TotalTakerPays");
SF_Amount const sfTakerGetsTotal  = make::one<SF_Amount::type>(&sfTakerGetsTotal,  STI_AMOUNT, 21, "TotalTakerGets");
SF_Amount const sfTxnRate         = make::one<SF_Amount::type>(&sfTxnRate,         STI_AMOUNT, 22, "TxnRate");
...
SF_Blob const sfIdent          = make::one<SF_Blob::type>(&sfIdent,          STI_VL,  5, "id");
...
SF_Blob const sfName            = make::one<SF_Blob::type>(&sfName,          STI_VL, 15, "Name");
...
SF_Blob const sfImprint         = make::one<SF_Blob::type>(&sfImprint,         STI_VL, 19, "Imprint");
...
SF_Account const sfApproved    = make::one<SF_Account::type>(&sfApproved,    STI_ACCOUNT, 5, "Approved");
SF_Account const sfOperator    = make::one<SF_Account::type>(&sfOperator,    STI_ACCOUNT, 6, "Operator");
...
SF_Account const sfChargeAccount = make::one<SF_Account::type>(&sfChargeAccount,  STI_ACCOUNT, 10, "ChargeAccount");
...
SF_Vec256 const sfIssues     = make::one<SF_Vec256::type>(&sfIssues,     STI_VECTOR256, 5, "Issues");
...
SField const sfPayee               = make::one(&sfPayee,               STI_OBJECT, 12, "Payee");
SField const sfTxFee               = make::one(&sfTxFee,               STI_OBJECT, 14, "TxFee");
...
SField const sfPayees          = make::one(&sfPayees,          STI_ARRAY, 10,"Payees");
SField const sfTxFees          = make::one(&sfTxFees,          STI_ARRAY, 12,"TxFees");
