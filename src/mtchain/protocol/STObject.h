...
#ifndef MTCHAIN_PROTOCOL_STOBJECT_H_INCLUDED
#define MTCHAIN_PROTOCOL_STOBJECT_H_INCLUDED
...
public:
    ...
    void addWithoutSigningFields (Serializer & s) const // only serializes signing fields
    {
        add (s, false);
    }
    ...
    */
    ...
    bool append (STObject const& obj);
private:
