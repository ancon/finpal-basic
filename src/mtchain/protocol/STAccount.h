...
#ifndef MTCHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define MTCHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a mtchain::uint160.  However, so the serialized format of the
