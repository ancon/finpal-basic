...
#ifndef MTCHAIN_PROTOCOL_STAMOUNT_H_INCLUDED
#define MTCHAIN_PROTOCOL_STAMOUNT_H_INCLUDED

#include <mtchain/basics/chrono.h>
#include <mtchain/basics/LocalValue.h>
...
private:
    ...
    bool mIsNative;      // A shorthand for isM(mIssue).
    bool mIsNegative;
    short mDecimal = 0;
...
public:
    ...
    int decimal() const noexcept { return mDecimal; }
    ...
    void
    setJson (Json::Value&, int options = 0) const;
    ...
    STAmount& operator= (MAmount const& amount)
    {
...
// IOUAmount and MAmount define toSTAmount, defining this
...
inline bool isM(STAmount const& amount)
{
    return isM (amount.issue().currency);
}
