...
#ifndef MTCHAIN_PROTOCOL_DIGEST_H_INCLUDED
#define MTCHAIN_PROTOCOL_DIGEST_H_INCLUDED
...
/*  Message digest functions used in the MTChain Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a MTChain account, from a message. Typically the
