...
#ifndef MTCHAIN_PROTOCOL_PUBLICKEY_H_INCLUDED
#define MTCHAIN_PROTOCOL_PUBLICKEY_H_INCLUDED
...
/** A public key.
    ...
    The format of the public key is MTChain specific,
...
protected:
    std::size_t size_ = 0;
    std::uint8_t buf_[MAX_PUBLIC_KEY_SIZE]; // should be large enough
