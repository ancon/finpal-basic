...
#ifndef MTCHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
#define MTCHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( alternatives );               // out: PathRequest, MTChainPathFind
...
JSS ( base_fee_fpa );                 // out: NetworkOPs
...
JSS ( destination_account );        // in: PathRequest, MTChainPathFind, account_lines
                                    // out: AccountChannels
JSS ( destination_amount );         // in: PathRequest, MTChainPathFind
JSS ( destination_currencies );     // in: PathRequest, MTChainPathFind
...
JSS ( issuer );                     // in: MTChainPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: RPCHelpers, LedgerRequest,
                                    //     MTChainPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( no_FinPal );                  // out: AccountLines
JSS ( no_FinPal_peer );             // out: AccountLines
...
JSS ( paths );                      // in: MTChainPathFind
JSS ( paths_canonical );            // out: MTChainPathFind
JSS ( paths_computed );             // out: PathRequest, MTChainPathFind
...
JSS ( reserve_base_fpa )   ;          // out: NetworkOPs
JSS ( reserve_inc );                // out: NetworkOPs
JSS ( reserve_inc_fpa );              // out: NetworkOPs
JSS ( response );                   // websocket
JSS ( result );                     // RPC
JSS ( FinPal_lines );               // out: NetworkOPs
JSS ( FinPal_state );               // in: LedgerEntr
JSS ( FinPalrpc );                  // RPC version
JSS ( role );                       // out: Ping.cpp
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: MTChainPathFind
...
JSS ( send_max );                   // in: PathRequest, MTChainPathFind
...
JSS ( source_account );             // in: PathRequest, MTChainPathFind
JSS ( source_amount );              // in: PathRequest, MTChainPathFind
JSS ( source_currencies );          // in: PathRequest, MTChainPathFind
...
JSS ( smart_contract );             // out: SmartContract
JSS ( Payees );                     // in: TransactionSign
JSS ( Payee );                      // in: TransactionSign
JSS ( TransferFee );                // out: AccountInfo 
JSS ( TransferRates );              // out: AccountInfo
JSS ( LimitAmounts );               // out: AccountInfo
