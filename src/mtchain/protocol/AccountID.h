...
#ifndef MTCHAIN_PROTOCOL_ACCOUNTID_H_INCLUDED
#define MTCHAIN_PROTOCOL_ACCOUNTID_H_INCLUDED
...
/** A special account that's used as the "issuer" for M. */
AccountID const&
mAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, FinPald should
...
public:
    ...
    /** Return mtchain::toBase58 for the AccountID
...
template <>
struct hash <mtchain::AccountID> : mtchain::AccountID::hasher
{
};
