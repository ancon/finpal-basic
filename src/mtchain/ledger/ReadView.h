...
#ifndef MTCHAIN_LEDGER_READVIEW_H_INCLUDED
#define MTCHAIN_LEDGER_READVIEW_H_INCLUDED

#include <mtchain/ledger/detail/ReadViewFwdRange.h>
...
#include <mtchain/ledger/detail/ReadViewFwdRange.ipp>
